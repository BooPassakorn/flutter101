...
import 'package:workshop/core/type/type.dart';
...
class CategoryItem extends StatelessWidget {
  const CategoryItem({Key? key, required this.category, this.onSelected,}) : super(key: key);
    ...
    return Container(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          color: category.isSelected ? LightColor.background : Colors
              .transparent,
          border: Border.all(
